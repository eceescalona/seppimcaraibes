namespace SeppimCaraibesApp.Data.Repository
{
    ...
    internal class OrderRepository
    {
        ...
        {
            return context.Orders.OrderByDescending(o => o.Date).Where(o => o.OrderProcessState == EOrderProcessState.Invoice && o.InvoiceState == EInvoiceState.Await).FirstOrDefault()?.InvoiceReference;
        }
